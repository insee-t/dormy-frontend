          ...
          <ListboxItem
            ...
            startContent={
              isCompact ? null : item.icon ? (
                <Icon
                  className={cn(
                    "text-black-500 group-data-[selected=true]:text-foreground ",
                    iconClassName,
                  )}
                  icon={item.icon}
                  width={24}
    ...
    return (
      <Listbox
        ...
        itemClasses={{
          ...
          title: cn(
            "text-small font-medium /* text-default-500 */ text-black-500 group-data-[selected=true]:text-foreground",
            itemClasses?.title,
          ),
        }}
        items={items}

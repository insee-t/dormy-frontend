...
// Use firstName and lastName, or username if available
      ...
      >
        ...
        >
          <img
            ...
            alt="Dormy"
            className={cn(
              "h-18 w-auto transition-all duration-200",
              {
      ...
      >
        <header className="sticky top-0 z-10  flex items-center justify-between rounded-medium border-small border-divider p-4 m-4 bg-white-500 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-medium font-medium text-black-500 hidden sm:block">{title}</h2>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="bg-blue-50 px-3 py-1 rounded-full flex items-center">
              <Icon
                ...
                color="white"
              />
              <span className="text-sm text-black-500 hidden sm:block">แพ็คเกจเหลือ 29 วัน</span>
            </div>
